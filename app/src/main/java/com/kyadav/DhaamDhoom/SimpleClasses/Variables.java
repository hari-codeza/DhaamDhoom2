...
public class Variables {
    ...
    public final static String root = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).toString() + "/";
    public final static String app_folder = root + "DhaamDhoom/";
    ...
    public static String tag = "unzip_";
