...
public class Variables {
    ...
    public static String root = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).toString() + "/";
    ...
    public static String app_folder = root + "DhaamDhoom/";
